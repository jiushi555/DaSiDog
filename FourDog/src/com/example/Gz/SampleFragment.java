...
public class SampleFragment extends Fragment implements OnItemClickListener {
	...
	private String url = Welcome.URL + "/dasidog/gz_pl_jz.php";
	...
	public SampleFragment(int mPosition, int headH, Context context,
			String re_type, Map good) {
	...
	class Gz_Pl_refresh extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			params.add(new BasicNameValuePair("gz_id", String
	...
	private void refresh() {
		...
		Intent it_to_a = new Intent(context, GzArticle.class);
